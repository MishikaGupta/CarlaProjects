...
try:
	...
	brake = lambda speed: carla.VehicleControl(hand_brake=brake)
	dropped_vehicle.apply_control(brake(0.5))
	time.sleep(5)
	...
	steering= lambda speed: carla.VehicleControl(steer = ster)
	...
	steering = lambda speed: carla.VehicleControl(steer=steer)
	dropped_vehicle.apply_control(steering(0.5))
	time.sleep(5)
